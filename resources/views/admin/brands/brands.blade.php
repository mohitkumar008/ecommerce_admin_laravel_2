                ...
                <div class="d-flex align-items-end flex-wrap">
                    <div class="me-md-3 me-xl-5">
                        ...
                        <div class="d-flex">
                            ...
                            <p class="text-primary mb-0 hover-cursor">Brands</p>
                        </div>

                    </div>
                </div>
                <div class="d-flex justify-content-between align-items-end flex-wrap">
                    <a href="{{ route('manageBrand') }}" class="btn btn-primary text-white mt-2 mt-xl-0">Add
                        Brand</a>
                </div>
            </div>
        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="template-demo d-flex justify-content-between flex-nowrap">
                                                ...
                                                @endif
                                                <a type="button"
                                                    href="{{ route('manageCoupon', ['id' => $list['id']]) }}"
                                                    title="Edit"
